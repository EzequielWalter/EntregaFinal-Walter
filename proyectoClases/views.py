...
def mi_template(request):
    cargar_archivo = open(r'C:\Users\Ezequiel Walter\Dropbox (CGPBB)\Ezequiel Walter\Ezequiel Walter\Documentos\Ezequiel\Python\proyecto-clases\templates\mi_template.html', 'r')
